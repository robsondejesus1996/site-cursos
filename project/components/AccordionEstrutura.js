...
const AccordionEstrutura = ({ title, active, setActive }) => {
  return (
    <div className="accordion">
      ...
      <div className={(active === title ? "show" : "") + " accordionContetEstrutura"}>
        <div className="containner">
          <p className={styles.descricao_estrutura}>
            ...
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
            aliquip ex ea commodo consequat.
            <img className={styles.imagem_geral} src="/images/Morfofuncional.jpg" />
            </p>
           
            <p><b>Veja mais fotos da estrutura - Laboratório Morfofuncional I e II</b></p>
